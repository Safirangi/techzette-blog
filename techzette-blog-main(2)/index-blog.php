...
$conn = new mysqli('localhost', 'root', '', 'techzette', 3306);
...
if(mysqli_query($conn, $sql)){
        ...
        /*. echo "<h3>Data stored in a database successfully! </h3>";" Please browse your localhost php my admin"
        . " to view the updated data echo nl2br("\nFull Name: $name\n"
        . "Email: $email\n");*/
